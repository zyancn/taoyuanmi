...
if request.Form("Action")="content" then
    prob_class=request.form("prob_class")
	  if prob_class="xxx" then
	    Call MessageBox("请选择一级分类！","add.asp?muen=3")
		response.End()
	  end if
    pros_class=request.form("pros_class")
	  if pros_class="xxx" then
	    Call MessageBox("请选择二级分类！","add.asp?muen=3")
		response.End()
	  end if
    Title=request.form("Title")
	  if Title="" then
	    Call MessageBox("请输入标题名称！","add.asp?muen=3")
		response.End()
	  end if
    content=request.form("content")
	  if content="" then
	    Call MessageBox("请输入描述内容！","add.asp?muen=3")
		response.End()
	  end if
...
rs.update
response.write("<script language='javascript'>alert('添加成功！');location.href='add.asp?muen=3'</script>")
rs.close
set rs=nothing
end if
%>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="43" class="admin_x_title">发布内容</td>
        </tr>
        </table>
...
pros_class.add(selects[prob_class.value][i]);}
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <option value="xxx" selected>请选择一级分类</option>
            <%
			set rs=server.createobject("adodb.recordset")
            sqlstr="select * from list_one"
            rs.open sqlstr,conn,3,1
            ...
            <option value="xxx">请选择二级分类</option>
            </select></td>
                </tr>
              <tr>
            ...
            <td width="30%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="40" height="50" align="left">黑白：</td>
              ...
              <tr>
                <td width="40" height="50" align="left">彩色：</td>
              ...
              <tr>
                <td width="40" height="50" align="left">图1：</td>
              ...
              <tr>
                <td width="40" height="50" align="left">图2：</td>
              ...
              <tr>
                <td width="40" height="50" align="left">图3：</td>
              ...
              <tr>
                <td width="40" height="50" align="left">图4：</td>
